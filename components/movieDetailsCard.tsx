                        ...
                        <header className="flex font-inter gap-x-5 bg-[rgba(0,0,0,0.5)] rounded-lg p-30 pb-0">
                            ...
                            <section className="flex flex-col justify-center gap-y-1.5">
                                ...
                                <section className="text-white mt-2.5 flex items-center gap-x-5">
                                    <button className="flex gap-x-1.5 bg-primary hover:bg-purple-500 rounded-full px-4 py-2">
                                        <img width={14} height={14} src="/assets/icons/play.svg" alt="play icon" />
                                        <p>Watch Now</p>
                                    </button>
                                    <button className="flex gap-x-1.5 border border-text-color bg-[#E5E2E1]/40 rounded-full px-4 py-2">
                                        <p>Watch Trailer</p>
                                    </button>
                            ...
                            </section>
                            {
                                data.casts && (
                                    <section>
                                        ...
                                        <div>
                                            <p>{data.casts.cast[0].profile_path}</p>
                                            {
                                                data.casts.cast.map((cast)=>(
                                                    <img src={`https://image.dbmb/t/p/${cast.profile_path}`} alt="" />
                                                ))
                                            }
                                        </div>
                                    </section>
